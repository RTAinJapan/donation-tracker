...
@csrf_exempt
def paypal_return_msf2022s(request):
...
@csrf_exempt
def paypal_return_msf2025s(request):
    return views_common.tracker_response(request, 'tracker/paypal_return_msf2025s.html')

@csrf_exempt
def paypal_return_msf2025w(request):
    return views_common.tracker_response(request, 'tracker/paypal_return_msf2025w.html')
